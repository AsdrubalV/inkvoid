      ...
      <div className="space-y-16 pb-16">
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 via-gray-800 to-black px-8 py-16 text-white text-center space-y-6">
          ...
          <div className="relative z-10 space-y-4 max-w-2xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold tracking-tight leading-tight">Tu historia merece<br />ser leida.</h1>
            <p className="text-gray-300 text-lg leading-relaxed">
              InkVoid es el espacio donde escritores publican sus novelas y lectores descubren su proxima obsesion.
              Fantasia, romance, ciencia ficcion, fanfiction y mucho mas.
            </p>
        ...
        {featuredStories.length > 0 && (
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-semibold tracking-tight">Lo mas leido esta semana</h2>
                ...
                <Link key={story.id} href="/signup" className="group space-y-1.5">
                  <div className="relative aspect-[2/3] w-full overflow-hidden rounded-lg border border-border bg-gray-100">
                    ...
                    <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                      <span className="text-white text-xs font-medium px-2 text-center">Registrate para leer</span>
                    </div>
                  </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-2xl bg-gradient-to-br from-gray-900 to-black p-6 text-white space-y-3">
            ...
            <p className="text-sm text-gray-300 leading-relaxed">Publica tu novela, construye tu audiencia y monetiza tu trabajo. Soportamos todos los generos.</p>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 p-6 space-y-3">
            ...
            <p className="text-sm text-gray-600 leading-relaxed">Descubre miles de historias unicas escritas por autores independientes.</p>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold tracking-tight">Explora por genero</h2>
        ...
        <div className="rounded-2xl bg-black text-white text-center py-12 px-6 space-y-4">
          ...
          <p className="text-gray-400 text-sm max-w-md mx-auto">Unete a InkVoid gratis. Lee, escribe y conecta con una comunidad apasionada por las historias.</p>
    ...
    <div className="space-y-4">
      ...
      {progressData && progressData.length > 0 && (
        <section className="space-y-3">
          <h2 className="text-base font-semibold tracking-tight">Continua leyendo</h2>
      ...
      <MoodboardRow title="Mas leidas (total)"          stories={mostRead ?? []}        href="/trending?sort=views" />
      <MoodboardRow title="Mas leidas hoy"              stories={storiesDay}            href="/trending?sort=views&period=day" />
      <MoodboardRow title="Mas leidas esta semana"      stories={storiesWeek}           href="/trending?sort=views&period=week" />
      <MoodboardRow title="Mas leidas este mes"         stories={storiesMonth}          href="/trending?sort=views&period=month" />
      <MoodboardRow title="Mas leidas este ano"         stories={storiesYear}           href="/trending?sort=views&period=year" />
      <MoodboardRow title="Mas votadas"                 stories={mostLiked ?? []}       href="/trending?sort=likes" />
